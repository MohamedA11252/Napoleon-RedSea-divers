...
export default function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-[#ae7f11] pl-4 pr-5 py-3 shadow-lg shadow-black/20 transition-all duration-500 hover:bg-[#1ebe5d] hover:shadow-xl hover:shadow-black/30 ${
